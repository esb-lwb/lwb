...
(comment
  ...
  ; (d)
  (println (vis '(and P (impl (not Q) (not P)))))
  ; (e)
  (println (vis '(impl P (and (not Q) (impl Q P)))))
  ; (f)
  (println (vis '(not (and (and (not Q) (impl P R)) (impl R Q)))))
  ; (g)
  (println (vis '(or (not P) (impl P Q))))
  ; (h)
  (println (vis '(impl (and P Q) (or (not R) (impl Q R)))))
  ; (i)
  (println (vis '(impl (or S (not P)) (not P))))
  ; (j)
  (println (vis '(impl (or (impl S (or R L)) (and (not Q) R)) (impl (not (impl P S)) R))))
  ; (k)
  (println (vis '(and (impl P Q) (impl (not R) (or Q (and (not P) R))))))
  
  (println (vis '(and (and (and P1 Q1) (and P2 Q2)) (and P3 Q3))))
  )
