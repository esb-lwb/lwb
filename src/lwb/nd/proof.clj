...
;; ## Preparing new proof lines after a deduction step
...
;; ### Interface for the user of proof: New plines as result of a deduction step

(defn new-plines
  "Creates all the new plines that must be added to the proof"
  [bodies]
